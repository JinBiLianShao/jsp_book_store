				...
				<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="th">
							...
							<ul class="pagination">
								<li><a
									href="/jsp_online_book_shop/CategoryServlet?method=getAllbooks&page=${nowpage - 1}">«</a></li>
								<c:forEach var="i" begin="1" end="${ pagesize }">
									<c:if test="${nowpage eq i}">
										<li><a class="active"
											href="/jsp_online_book_shop/CategoryServlet?method=getAllbooks&page=${nowpage}">${i}</a></li>
									</c:if>
									<c:if test="${nowpage ne i}">
										<li><a
											href="/jsp_online_book_shop/CategoryServlet?method=getAllbooks&page=${i}">${i}</a></li>
									</c:if>
								</c:forEach>
								<li><a
									href="/jsp_online_book_shop/CategoryServlet?method=getAllbooks&page=${nowpage + 1}">«</a></li>
